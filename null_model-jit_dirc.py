...
def calculate_thresholds(i, j, tlen, nodes, tm, iteration_num):
    ...
    index_seas = np.array(index_day, dtype='uint32')
    dayseries1[:i] = 1
    dayseries2[:j] = 1
...
if __name__ == '__main__':
    ...
    for tm in [30]:
        ...
        np.save('P_2000_3ms_mnoe393_thresholds_05_tm%d_jit_dirc' % tm, P1)
        np.save('P_2000_3ms_mnoe393_thresholds_02_tm%d_jit_dirc' % tm, P2)
        np.save('P_2000_3ms_mnoe393_thresholds_01_tm%d_jit_dirc' % tm, P3)
        np.save('P_2000_3ms_mnoe393_thresholds_005_tm%d_jit_dirc' % tm, P4)
        np.save('P_2000_3ms_mnoe393_thresholds_001_tm%d_jit_dirc' % tm, P5)
        print("finish.....................")